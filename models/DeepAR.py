...
class Net(nn.Module):
    def __init__(self, params, device):
        ...
        self.relu = nn.ReLU()
        self.distribution_mu = nn.Linear(40 * 3, 1)
        self.distribution_presigma = nn.Linear(40 * 3, 1)
    ...
    def forward(self, x, idx, hidden, cell):
        ...
        lstm_input = x # torch.cat((x, onehot_embed), dim=2)
    ...
    def init_hidden(self, input_size):
        return torch.zeros(3, input_size, 40, device=self.device)
